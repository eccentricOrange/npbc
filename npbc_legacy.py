    ...
    def read_args_for_undelivered_dates(self):
        ...
        if len(undelivered_string.split()) > 0:
            for paper in undelivered_string.split(';'):
                ...
                self.undelivered_strings[f"{self.month}/{self.year}"][paper_key] = string
    ...
    def report_undelivered_dates(self, paper_key: str):
        ...
        while not finished:
            ...
            if string == '?' or string == '':
                ...
                self.undelivered_dates[f"{self.month}/{self.year}"][paper_key] = self.parse_undelivered_string(undelivered_dates, string)
